...
* **Virtuelle Zustandshaltung (`_sim_angles`):**
  Im Simulationsbetrieb führt der Controller den Soll-Zustand im Array `_sim_angles` lokal mit. Die Abfragemethode `get_angles()` liefert dadurch auch ohne Netzwerk-Rückkanal sofort konsistente Winkelwerte zurück.
